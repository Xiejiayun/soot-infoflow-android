...
public class Application {
     ...
     *
     * @param callbackClasses The class names of callbacks or null to use the default file.
     */
     ...
     * no taint wrapping is used.
     *
     * @param taintWrapper The taint wrapper to use or null to disable taint wrapping
     */
...
//        this.collectedSinks = info.getCollectedSinks();
     ...
     *
     * @param config The extra Soot configuration options to be used when running the analysis, null if the defaults shall
     *               be used
     */
     ...
     *
     * @param factory The factory to be used. If null is passed, the default factory is used.
     */
